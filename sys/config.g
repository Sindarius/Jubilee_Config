...
M569.1 P50.0 T2 C5 R150 I25 D0.11 H50          ; Drive 0 | X stepper 1000PPR
M569.1 P51.0 T2 C5 R120 I125 D0.08 H50          ; Drive 1 | Y Stepper 1000PPR
...
M917 X80 Y80                       ;Hold Current
M584 X50.0 Y51.0                ; X and Y for CoreXY
M906 X1400 ;{1.8*sqrt(2)*2000}  ; LDO XY 2000mA RMS the TMC5160 driver on duet3
M906 Y1400 ;{1.8*sqrt(2)*2000}  ; generates a sinusoidal coil current so we can 
...
;## TOOLS T0 = 20
M584 E20.0:21.0    ;Extruder
M569 P20.0 S1 ; Direction
M569 P21.0 S0 ;Reversed the wiring on this one

;#tool movement
M350 E16:16 I1           ;microstepping
M92 E690:690			  ;steps
M203 E7200:7200            ;max feed rate
M566 E400:400             ;jerk
M201 E10000:10000           ;max accel
M906 E1000:1000 I10        ;Current (I Idle%)
M572 D0:1 S0.45            ;Pressure Advance
...
;-------------------------------------------------------------------------------
M201 X800 Y800                        ; Accelerations (mm/s^2) 11000 default
...
M98 P"Tools/BabyBullet.g" B20 T0 S"Tool 0" X0.172 Y33.25 Z-2.05
M98 P"Tools/BabyBullet.g" B21 T1 S"Tool 1" X-0.3 Y32.93 Z-2.23
